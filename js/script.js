;(function( $ ) {
	...
	$( document ).on( 'ready', function() {
		 ...
		 * =======================================
		 */
		$(".app-list label").click(function(){
			$(":checkbox").not($(this).siblings('input')).removeAttr("checked");
		});
		...
		if ( $.fn.responsiveSlides ) {
			$body.on( 'pageStart', function() {
				$( '.section-background-slideshow' ).responsiveSlides({
					...
					timeout : $( this ).data( 'timeout' ) ? $( this ).data( 'timeout' ) : 10000,
				});
			});
		};
